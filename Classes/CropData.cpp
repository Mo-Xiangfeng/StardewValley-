...
void CropDatabase::init() {
    ...
    cauliflower_seed->id = 1101;
    cauliflower_seed->name = "cauliflower_seed";
    cauliflower_seed->iconPath = "item/1101.png";
    cauliflower_seed->season = CropSeason::SPRING;
    cauliflower_seed->growthDays = 6;
    ...
    tomato_seed->iconPath = "item/1103.png";
    tomato_seed->season = CropSeason::SUMMER;
    tomato_seed->growthDays = 4;
    ...
    wheat_seed->iconPath = "item/1106.png";
    wheat_seed->season = CropSeason::ALL_SEASON;
    wheat_seed->growthDays = 3;
    wheat_seed->price = 5;
